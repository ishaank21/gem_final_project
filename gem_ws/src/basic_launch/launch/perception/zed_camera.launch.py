...
vehicle_name=os.environ.get('VEHICLE_NAME','VEHICLE_NAME not exported set e2 or e4')
if vehicle_name == "":
    print(f"[ERROR] VEHICLE_NAME not exported")
    exit
print(f"Selected vehicle_name: {vehicle_name}")
